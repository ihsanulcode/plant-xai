...
def create_train_val_dataloaders(data_dir, batch_size, num_workers=4):
    ...
    data_transforms = {
        'train': transforms.Compose([
            # transforms.RandomResizedCrop(244, scale=(0.7, 1.0)),
...
class ModelTrainer:
    ...
    def save_metrics_to_excel(self):
        ...
        save_path = os.path.join(self.save_dir, "customModel_data_augmentation.xlsx")
...
if __name__ == "__main__":
    ...
    data_dir = 'dataset'
    save_dir = "Model_Outputs/customModel_data_augmentation"
    batch_size = 32
    num_epochs = 30
